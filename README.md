...
긴 리뷰를 작성하기 귀찮은 사용자들을 위한 기능<br>
CRUD, 좋아요, 싫어요 기능 RESTful하게 구현<br>
영화제목 검색 시, 영화를 찾을 수 있도록 모달창을 제공<br>
페이징, 검색 기능 구현<br>
<br><br><br><br>
...
리뷰와 자유글을 분리한 각각의 게시판<br>
제목 및 내용, 작성자, 태그 3가지 받식의 검색<br>
<br><br><br><br>


<h5>* 리뷰, 자유 게시판</h5>
<img src="img/FreeDetailShow.gif" width="900"/>
게시글과 댓글에 좋아요 기능을 포함<br>
RESTful하게 댓글 및 대댓글 기능 구현<br>
댓글의 계층과 페이징 기능<br>
-통상적으로 댓글 0단계는 최신순으로, 댓글 1단계 이후로는 따라 읽어나가기 쉽도록 그 반대로 정렬되는 경우가 많다는 점에 착안.
-Serial Varchar field를 내림차순 정렬하여 결과 반환.
-level 1의 댓글의 경우 Serial은 auto increment와 같음
