			...
			<form method="post" name="regiform" id="regist_form" class="form"
				...
				<div>
					<input type="text" name="id" id="id" placeholder="ID" required
						oninput="checkIdtest()"> <span class="error_next_box"
						id="idError"></span>
				</div>
				...
				<div id="bir_wrap">
					...
					<div id="bir_yy">
						<span class="box"> <input type="text" id="yy"
							name="yy" class="int" maxlength="4" placeholder="년(4자)">
							<span class="error_next_box" id="yyError"></span>
						</span>
					</div>
					<!-- 월일 입력구문 -->
					<div id="bir_mm">
						<span class="box"> <select id="mm" name="mm">
								<option>월</option>
					...
					<div id="bir_dd">
						<span class="box"> <input type="text" id="dd"
							name="dd" class="int" maxlength="2" placeholder="일">
						</span>
					</div>
...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/resources/js/signup2.js?ver=3"></script>
<!-- sumbit 눌렀을때 동작 : signup.js -->
<script type="text/javascript"
	src="${pageContext.request.contextPath}/resources/js/signup.js?ver=3"></script>
