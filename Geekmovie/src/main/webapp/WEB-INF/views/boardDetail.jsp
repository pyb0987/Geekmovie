		...
		<div id="detail-MovieContainer">
			...
			<div id="detail-nonPoster">
				...
				<div class="detail-Click clickBox">
					<div class="heartClickBig heartClick">
						<div class="heartClickBigClicker heartClickClicker"></div>
					</div>
		...
		<div class="BoardWrap">
			...
			<div class="Boardbody">
				...
				<div class="movieScore BoardColored">
					<h5>평가 :</h5>
					<span class="star-rating">${data.b_score}</span>
				</div>
				...
				<div class="Detail-body-header likedislike">
					<div class="like-dislike">
						<div class="like-button like-dislike-button">
							<span class="like-button-span like-dislike-button-span">${data.likes}</span>
							<img class="like-icon" src="${path}/resources/img/like.png">
						</div>
				...
				<div class="BoardColored writer">
					<button id="b_modify" onclick=" modifyCheck();">
						<h5>게시글 수정</h5>
					</button>
				</div>
				<div class="BoardColored writer">
		...
		<div id="comments-container">
			...
			<div>
				<form name="replywriteform" method="post" action="/movie/write">
					<p>
						${sessionScope.id} <input type="hidden" name="writer"
					...
					<p>
						<input type="hidden" name="seq" value="${data.seq}"> <input
							type="button" id="reply_write" onclick="replyWriteCheck();"
							value="작성">
					</p>
				</form>
			</div>
