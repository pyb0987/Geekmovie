...
public class FreeReplyVo {
    ...
    private int likes;
    private FreeReplyLikeVo freeReplyLikeVo;
	...
	public FreeReplyVo(int replyId, int boardId, int ancestorId, int depth, String orderserial, String content,
		...
		this.likes = likes;
		this.freeReplyLikeVo = freeReplyLikeVo;
	}
	...
	public FreeReplyLikeVo getFreeReplyLikeVo() {
		return freeReplyLikeVo;
	}

	public void setFreeReplyLikeVo(FreeReplyLikeVo freeReplyLikeVo) {
		this.freeReplyLikeVo = freeReplyLikeVo;
	}
